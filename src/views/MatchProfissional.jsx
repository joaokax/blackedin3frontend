/*
FALTA COLOCAR OS STYLE NO STYLE.CSS
*/

import React from "react";
import "../assets/css/style.css";

export default function MatchProfissional() {
    return (
        <>
    ...
    <div className="row">
        <div className="container-card col">
            ...
            <div id="buttons" className="d-flex justify-content-center mb-3">
                <a href="#desconsiderar"><div id="x" className="all-btn"><i className="bi bi-x-circle"></i>&nbsp; Desconsiderar</div></a>
                <a href="#match"><div id="heart" className="all-btn"><i className="bi bi-heart-fill"></i>&nbsp; Gostei</div></a>
                <a href="#favoritar"><div id="star" className="all-btn"><i className="bi bi-star"></i>&nbsp; Favoritar</div></a>
            </div>
